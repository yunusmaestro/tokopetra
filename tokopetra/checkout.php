	...
	<script>
		$(document).ready(function(){
			...
			$('.choice').click(function(){
				...
				var total_harga = parseInt(hargaBarang) + parseInt(hargaOngkir) - parseInt(ongkirSebelumnya);
	...
	<div class="container my-5" style="max-width:75%;">
		<div class="row">
			...
			<div class="col-8">
				...
				<div class="root Product1">
					...
					<div class="row my-3">
						<div class="col-6">
							...
							<div class="dropdown">
								<button class="btn btn-block dropdown-toggle bgGreen round cWhite bold f-15 h-45" type="button" id="dropdownMenuButton1" data-toggle="dropdown">	
									Pengiriman
								</button>
					...
					<div class="subtotal">
						<div class="row">
							...
							<div class="col-5 text-right trigger orange clicky wrapper-subtotal" data-toggle="collapse" data-target="#collapseExample">
								
							</div>
							<svg width="18px" height="18px" viewBox="0 0 16 16" class="bi bi-caret-down-fill trigger my-1 clicky" fill="currentColor" data-toggle="collapse" data-target="#collapseExample" xmlns="http://www.w3.org/2000/svg">
				...
				<button type="button" class="btn btn-block round bgOrange h-60 bayarSekarang" data-toggle="modal" data-target="#checkOutPayment"><b class="cWhite">Bayar Sekarang</b></button>
								...
								<div class="modal-body">
									...
									<div class="row">
										...
										<div class="col-5 my-1 text-right">
											<input type="button" class="triggerConfirm btn btn-block round bgOrange bold f-16 cWhite"value="Bayar">
										</div>
									</div>
								</div>
							</div>
